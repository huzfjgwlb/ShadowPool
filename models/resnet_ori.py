...
class ResNet(nn.Module):
    def __init__(self, block, num_blocks, num_classes=10, ratio=1, **kwargs):
...
def resnet18_ori(**kwargs):
    return ResNet(BasicBlock, [2, 2, 2, 2], **kwargs)


def resnet34_ori(**kwargs):
    return ResNet(BasicBlock, [3, 4, 6, 3], **kwargs)


def resnet50_ori(**kwargs):
    return ResNet(Bottleneck, [3, 4, 6, 3], **kwargs)


def resnet101_ori(**kwargs):
    return ResNet(Bottleneck, [3, 4, 23, 3], **kwargs)


def resnet152_ori(**kwargs):
...
if __name__ == "__main__":
    ...
    model = resnet18_ori(num_classes=10, ratio=1.0)
